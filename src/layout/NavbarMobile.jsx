import NotchSvg from "../components/ui/NotchSvg"
    ...
    return (
        <nav className={`fixed bottom-0 left-0 right-0 z-50 lg:hidden ${className}`}>
            <div className="relative h-28 px-4">
                ...
                <div
                    className="absolute bottom-0 left-4 right-4 border border-(--bg-sec) h-16 bg-(--bg-main) rounded-tl-md rounded-tr-md shadow-xl z-10 transition-all duration-300 "
                    style={{
                        WebkitMaskImage: `
                        radial-gradient(
                                ...
                                <li key={item.id} className="relative flex-1 flex justify-center">
                                    <span
                                        className={`
                                            ...
                                            ${active
                                                ? 'opacity-80 scale-100 -top-2'
                                                : 'opacity-0 scale-75 top-0'
                                            }
                    `}
                                    />
                                </li>
                                    ...
                                    >
                                        ...
                                        <span
                                            className={`
                                                ...
                                                ${active
                                                    ? '-top-11 opacity-100 scale-100'
                                                    : 'top-0 opacity-0 scale-75'
                                                }
                                        `}
                                        />
                                        ...
                                        <span
                                            className={`
                                                ...
                                                transition-all duration-300 ease-out
                                                ${active
                                                    ? '-translate-y-7 text-white text-2xl'
                                                    : 'text-xl'
                                                }
                                            `}
                                        >
